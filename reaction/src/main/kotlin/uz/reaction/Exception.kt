...
sealed class ReactionException(message: String? = null) : RuntimeException(message) {
...
class StatNotFoundException : ReactionException() {
    override fun errorType() = ErrorCode.STATS_NOT_FOUND
}
